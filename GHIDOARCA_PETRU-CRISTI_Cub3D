...
namespace Main
{
    ...
    internal class Window3D : GameWindow
    {
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            {
                // Toggle color modification flag
                modifyColors = !modifyColors;

                if (modifyColors)
                {
                    // Modifică culorile feței aici între valorile minime și maxime pentru fiecare canal de culoare
        ...
        private void DrawCube()
        {
            ...
            for (int i = 0; i < 35; i = i + 3)
            {
                ...
                else
                {
                    ...
                    // Afiseaza Valorile RGB in consola
                    Console.WriteLine($"RGB: ({red}, {green}, {blue})");

                    // Seteaza culorile predefinite
